...
export default function Relevance() {
  ...
  const handleCompute = async () => {
    ...
    try {
      ...
      setError(err?.response?.data?.detail || "İlgi skoru hesaplanırken hata");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="relevance-page">
      <div className="relevance-header">
        ...
        <p className="relevance-subtitle">
          Skorlama sonrası, marka profili ile keyword'lerin alaka düzeyini
          hesaplar
        </p>
      </div>
      ...
      <div className="relevance-controls">
        <div className="control-row">
          ...
          <button
            ...
            title={
              !hasConfirmedProfile
                ? "Aktif çalışmanın onaylanmış profili yok"
                : ""
            }
          >
            <Calculator size={16} />
        ...
        {!hasConfirmedProfile && activeWorkspace && (
          <div className="disabled-hint">
            <AlertCircle size={14} />
            Aktif çalışmanın onaylanmış profili yok. Önce Marka Profili
            sayfasından profili onaylayın.
          </div>
        )}
      </div>
